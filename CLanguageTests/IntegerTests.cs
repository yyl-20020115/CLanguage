...
{
    private static void TestPromote (MachineInfo mi, string type, int resultBytes, Signedness signedness)
    {
    ...
    private static void TestArithmetic (MachineInfo mi, string type1, string type2, CBasicType result)
    {
        var report = new Report (new TestPrinter ());
